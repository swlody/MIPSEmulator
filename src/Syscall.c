...
void SyscallExe(uint32_t SID) {
    ...
    switch(SID) {
        ...
        case 4050:{
            printf("SYSCALL Getegid\n");
            RegFile[2] = syscall(SYS_getegid);
            break;
        }
        case 4064:{
            printf("Getppid at time:\n");
            RegFile[2] = syscall(SYS_getppid);
            break;
        }
        case 4065:{
            printf("Getpgrp at time:\n");
            RegFile[2] = syscall(SYS_getpgrp);
            break;
        }
        case 4076:{
            printf("Getrlimit at time:\n");
            RegFile[2] = syscall(SYS_getrlimit);
            break;
        }
        case 4077:{
            printf("Getrusage at time:\n");
            RegFile[2] = syscall(SYS_getrusage);
            break;
        }
        case 4078:{
            printf("GetTimeofDay at time:\n");
            RegFile[2] = syscall(SYS_gettimeofday,NULL,NULL);
            break;
        }
        case 4090:{
            printf("SYSCALL MMap :\n");
